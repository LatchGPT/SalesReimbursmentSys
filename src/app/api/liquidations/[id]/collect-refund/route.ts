...
import { collectLiquidationRefund } from '../../../../../services/liquidations/liquidations';
...
export async function POST(request: Request, context: Context): Promise<Response> {
  return withPersistenceScope(async () => {
    ...
    const result = await collectLiquidationRefund(request.headers.get('x-user-id'), id, body);
